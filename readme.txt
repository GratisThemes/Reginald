...
# Copyright
Reginald WordPress Theme, Copyright (C) 2016-2021, Gratis Themes
...
- Added setting to remove vertical margin
- Redesigned header menu
- Redesigned and reworked post formats
- Redesigned buttons and form elements
- Redesigned entry tags
